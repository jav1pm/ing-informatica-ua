...
**Lenguaje utilizado =>** `MPI` mediante el software [MPICH] (https://github.com/pmodels/mpich) utilizado para el paso de mensajes en aplicaciones de memoria distribuida en computación paralela.
