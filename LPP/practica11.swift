...
print("\n******\n1a) En la linea 20, se ha declarado una instancia de una estructura con let siendo la variable s1 constante y todas las propiedades de esa instancia tambien")
print("por lo que no se podrá modificar. Por eso el error en la linea 25, está intentando modificar la variable x.\n******")
...
struct Cuadrado {
    ...
    func movido1(incX: Double, incY: Double) -> Cuadrado {
        let cuadrado = Cuadrado(esquina: esquina.movida(incX: incX, incY: incY),
                                lado: lado)
        return cuadrado
    }
...
print("\n******\n1c) Indica qué muestra por pantalla la función print: \n******")
...
print("\n******\n2a) ¿Qué se imprime al final de su ejecución?: \n******")

var val1 = Valor()
var val2 = Valor()
val1.valor = 20
val2.valor = 8
print(val1.valor + val2.valor + Valor.z)
// Imprime 10 + 8 + 28 = 46
...
//     // override var patas = 20
//     //  No se puede sobreescribir el valor de una propiedad almacenada, 
//     //  pero si el getter y el setter.
//     override var patas: Int {
//         get {
//             return super.patas + 2
//         }
//         set {
//             print("Valor de patas actualizado con : \(newValue)")
//             super.patas = newValue
//         }
//     }

//     // Si se puede añadir un observador a una propiedad de la clase base dentro de la derivada.
//     override var orejas: Int {
//         willSet {
//             print("Cambio en el valor de orejas : \(newValue)")
//         }
//     }
