...
-- 6.a) Genera numeros aleatorios hasta que interrumpamos su ejecución.

-- 6.b) Se está utilizando el paquete Ada.Integer_Text_IO ya que T_Digito es un subtipo de Integer.
