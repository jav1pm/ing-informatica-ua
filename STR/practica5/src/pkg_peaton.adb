...
package body PKG_peaton is
   ...
   begin
      ...
      Siguiente := Clock + TIEMPO_ESPERA_PEATON;
      SELECT
         PKG_Taxi.OP_Recogida.Recogida_Peaton;
         PKG_graficos.Actualiza_Color_Peaton(Green, peaton => peaton);

      OR
         delay until Siguiente;
         PKG_graficos.Actualiza_Color_Peaton(Black, peaton => peaton);
      END SELECT;
