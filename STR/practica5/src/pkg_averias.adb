...
PACKAGE BODY Pkg_Averias IS
   ...
   PROTECTED body T_OP_Indicador_Averia IS
      ...
      ENTRY interrumpir_creacion_coches WHEN NOT (Indicador_Averia = NO_AVERIA) Is
      begin
         null;
      end interrumpir_creacion_coches;

      ENTRY Reanudar_marcha WHEN (Indicador_Averia = NO_AVERIA) IS
      BEGIN
         NULL;
      END Reanudar_marcha;
